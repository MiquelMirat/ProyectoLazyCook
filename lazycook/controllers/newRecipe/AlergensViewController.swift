...
class AlergensViewController: UIViewController {
...
extension AlergensViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue: "alergenSelected"), object: nil, userInfo: alergenos)
